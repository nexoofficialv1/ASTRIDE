...
required={
 'passenger_flutter':{'http','shared_preferences','flutter_secure_storage','connectivity_plus','web_socket_channel','geolocator','google_maps_flutter','flutter_map','latlong2','permission_handler','firebase_core','firebase_messaging','firebase_app_check','cryptography','url_launcher','image_picker'},
 'driver_flutter':{'http','shared_preferences','flutter_secure_storage','connectivity_plus','web_socket_channel','geolocator','google_maps_flutter','flutter_map','latlong2','permission_handler','firebase_core','firebase_messaging','firebase_app_check','cryptography','url_launcher','image_picker'},
