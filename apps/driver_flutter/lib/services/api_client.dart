...
class ApiClient {
  ...
  Future<Map<String,dynamic>> patchJson(String path,Map<String,dynamic> body) async=>_decode(await _client.patch(Uri.parse('${AppConfig.apiBaseUrl}$path'),headers:_headers(),body:jsonEncode(body)).timeout(AppConfig.requestTimeout));
  Future<Map<String,dynamic>> putJson(String path,Map<String,dynamic> body) async=>_decode(await _client.put(Uri.parse('${AppConfig.apiBaseUrl}$path'),headers:_headers(),body:jsonEncode(body)).timeout(AppConfig.requestTimeout));
